...
export const STAGE_MANIFEST: StageMeta[] = [
  ...
  { id: "lev1-hatsuon-q",     category: "Lev1",    azikLevel: "Lev1b", wordCount: 1400, name: "ん",                          description: "「ん」は [q] 一打で！N キーは忘れよう。Lev2 で更に短縮できるようになる。",           concept: "ん→[q] の習得。子音前置の撥音拡張 (kz等) は Lev2a で学ぶ。このステージでは ho+q のように「前の音節＋q」で打つ。" },
  { id: "lev1-sha",           category: "Lev1",    azikLevel: "Lev1c", wordCount:  990, name: "シャ行 [X]",                  description: "「しゃ/しゅ/しょ」は [x] で2打鍵に短縮。SHA/SYA などは忘れよう。",                    concept: "x*系 (xa/xu/xo/xz/xj/xl/xh/xp) の習得。チャ行 [C] は Lev1d で学ぶ。" },
  { id: "lev1-cha",           category: "Lev1",    azikLevel: "Lev1d", wordCount:  781, name: "チャ行 [C]",                  description: "「ちゃ/ちゅ/ちょ」は [c] で2打鍵に短縮。CHA/CYA などは忘れよう。",                    concept: "c*系 (ca/cu/co/cz/cj/cl/ch/cp) の習得。シャ行 [X] と合わせて x*/c* を使い分ける。" },
  ...
  { id: "lev2a-an-z",        category: "Lev2a",   azikLevel: "Lev2a", wordCount: 2614, name: "撥音「〜あん」[Z]",            description: "「〜あん」を子音＋[z] で！かん→kz, さん→sz, たん→tz, なん→nz など。",               concept: "あん拡張キー [Z]。子音+Z = 〜あん。例: kz=かん, sz=さん, tz=たん, nz=なん, hz=はん, mz=まん, gz=がん。" },
  { id: "lev2a-in-k",        category: "Lev2a",   azikLevel: "Lev2a", wordCount: 1286, name: "撥音「〜いん」[K]",            description: "「〜いん」を子音＋[k] で！きん→kk, しん→sk, にん→nk, ちん→tk など。",               concept: "いん拡張キー [K]。子音+K = 〜いん。例: kk=きん, sk=しん, nk=にん, tk=ちん, bk=びん。" },
  { id: "lev2a-un-j",        category: "Lev2a",   azikLevel: "Lev2a", wordCount:  488, name: "撥音「〜うん」[J]",            description: "「〜うん」を子音＋[j] で！くん→kj, すん→sj, ぶん→bj, ぐん→gj など。",               concept: "うん拡張キー [J]。子音+J = 〜うん。例: kj=くん, sj=すん, bj=ぶん, gj=ぐん, hj=ふん。" },
  { id: "lev2a-en-d",        category: "Lev2a",   azikLevel: "Lev2a", wordCount: 1870, name: "撥音「〜えん」[D]",            description: "「〜えん」を子音＋[d] で！けん→kd, せん→sd, てん→td, ねん→nd など。",               concept: "えん拡張キー [D]。子音+D = 〜えん。例: kd=けん, sd=せん, td=てん, nd=ねん, gd=げん。" },
  { id: "lev2a-on-l",        category: "Lev2a",   azikLevel: "Lev2a", wordCount:  978, name: "撥音「〜おん」[L]",            description: "「〜おん」を子音＋[l] で！こん→kl, そん→sl, とん→tl, のん→nl など。",               concept: "おん拡張キー [L]。子音+L = 〜おん。例: kl=こん, sl=そん, tl=とん, hl=ほん, ml=もん。" },
  ...
  { id: "lev2b-ai-q",        category: "Lev2b",   azikLevel: "Lev2b", wordCount: 2346, name: "二重母音「〜あい」[Q]",        description: "「〜あい」を子音＋[q] で！かい→kq, さい→sq, たい→tq, ない→nq など。",               concept: "あい拡張キー [Q]。子音+Q = 〜あい。注: q 単打は ん。例: kq=かい, sq=さい, tq=たい, gq=がい。" },
  { id: "lev2b-uu-h",        category: "Lev2b",   azikLevel: "Lev2b", wordCount:  740, name: "二重母音「〜うう」[H]",        description: "「〜うう」を子音＋[h] で！くう→kh, すう→sh, つう→th, ふう→hh など。",               concept: "うう拡張キー [H]。子音+H = 〜うう。例: kh=くう, sh=すう, th=つう, hh=ふう, gh=ぐう。" },
  { id: "lev2b-ei-w",        category: "Lev2b",   azikLevel: "Lev2b", wordCount: 1266, name: "二重母音「〜えい」[W]",        description: "「〜えい」を子音＋[w] で！けい→kw, せい→sw, てい→tw, へい→hw など。",               concept: "えい拡張キー [W]。子音+W = 〜えい。例: kw=けい, sw=せい, tw=てい, hw=へい, gw=げい。" },
  { id: "lev2b-ou-p",        category: "Lev2b",   azikLevel: "Lev2b", wordCount: 3108, name: "二重母音「〜おう」[P]",        description: "「〜おう」を子音＋[p] で！こう→kp, そう→sp, とう→tp, のう→np など。",               concept: "おう拡張キー [P]。子音+P = 〜おう。例: kp=こう, sp=そう, tp=とう, np=のう, gp=ごう。" },
  ...
  { id: "lev3a-compat-f",   category: "Lev3a",   azikLevel: "Lev3a", wordCount:  250, name: "語尾互換 [F]",                 description: "き→kf, で→df, ぬ→nf, ふ→hf, む→mf, ゆ→yf, じゅ→jf で1打削減！",                  concept: "F互換キー練習。末尾i/u代わりにFを使う短縮入力。kf=き, df=で, nf=ぬ, hf=ふ, mf=む, yf=ゆ, jf=じゅ。" },
