...
export const STAGE_MANIFEST: StageMeta[] = [
  ...
  { id: "lev1-sha",           category: "Lev1",    azikLevel: "Lev1c", wordCount:  668, name: "シャ行 [X]",                  description: "「しゃ/しゅ/しょ」は [x] で2打鍵に短縮。SHA/SYA などは忘れよう。",                    concept: "x+母音系 (xa/xi/xu/xe/xo) の習得。チャ行 [C] は Lev1d で学ぶ。" },
  { id: "lev1-cha",           category: "Lev1",    azikLevel: "Lev1d", wordCount:  197, name: "チャ行 [C]",                  description: "「ちゃ/ちゅ/ちょ」は [c] で2打鍵に短縮。CHA/CYA などは忘れよう。",                    concept: "c+母音系 (ca/ci/cu/ce/co) の習得。シャ行 [X] と合わせて x*/c* を使い分ける。" },
  { id: "lev1-summary",       category: "Lev1",    azikLevel: "Lev1d", wordCount: 107332, name: "Lev1 まとめ文章",              description: "「っ」「ん」「シャ行」「チャ行」の総まとめ。",                                         concept: "Lev1全体の総合練習。っ[;]・ん[q]・シャ行[x]・チャ行[c] をすべて活用する文章。" },
  ...
  { id: "lev2a-summary",     category: "Lev2a",   azikLevel: "Lev2a", wordCount: 241589, name: "撥音まとめ文章",               description: "Z/K/J/D/L の5つの撥音拡張をフル活用する文章練習。",                                   concept: "Lev2a総合練習。5つの撥音拡張キー (Z/K/J/D/L) を自然な文章の中で使いこなす。" },
